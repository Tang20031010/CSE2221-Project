...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        int s1Overlap = str1.length() - overlap;
        String combination = str1.substring(0, s1Overlap) + str2;
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        int count = 0;
        /*
         * Iterate through set to check if str is substring of any strings in
         * set
         */
        for (String x : strSet) {
            /*
             * If str is not substring of strings, count plus one
             */
            if (!x.contains(str)) {
                count++;
            }
        ...
        /*
         * Check if the str is substring of any strings in the set
         */
        if (count == size) {
            /*
             * Declare and initialize Set temp
             */
            Set<String> temp = new Set1L<>();
            /*
             * if str is not substring of any strings in the set, add str to
             * temp
             */
            temp.add(str);
            /*
             * Iterate through element in the strSet
             */
            while (strSet.size() != 0) {
                String tempString = strSet.removeAny();
                /*
                 * If strings in strSet is not the substring of str, add the
                 * element to temp
                 */
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        /*
         * Declare and initialize sSet
         */
        Set<String> sSet = new Set1L<>();

        /*
         * Iterate through element in the input
         */
        while (!input.atEOS()) {
            String sTemp = input.nextLine();
            /*
             * Call addToSetAvoidingSubstrings method
             */
            addToSetAvoidingSubstrings(sSet, sTemp);
        }
        /*
         * return statement
         */
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        for (int i = 0; i < text.length(); i++) {
            /*
             * If the character is '~' create a new line, if it is not, print
             * out the character
             */
            if (text.charAt(i) == '~') {
                out.println();
