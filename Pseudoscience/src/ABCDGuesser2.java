...
public final class ABCDGuesser2 {
    ...
    /**
     * Do de Jager Formula calculation and output a,b,c,d in the formula, the
     * approximated constant, and the smallest relative error.
     *
     * @param num
     *            a constant input by the user
     * @param w
     *            the w in the formula input by the user
     * @param x
     *            the x in the formula input by the user
     * @param y
     *            the y in the formula input by the user
     * @param z
     *            the z in the formula input by the user
     * @param out
     *            the output stream
     */
    public static void deJagerFormulaCal(double num, double w, double x,
        ...
        double temp = 0.0;
        /*
         * Declare and initialize countA, countB, countC, and countD to count
         * the number of times the four loops repeat itself
         */
         ...
         */
        for (countD = 0; countD < length; countD++) {
            for (countC = 0; countC < length; countC++) {
                for (countB = 0; countB < length; countB++) {
    ...
    public static void main(String[] args) {
         ...
         */
        double num1 = getPositiveDouble(in, out);
        /*
         ...
         */
        double w1 = getPositiveDoubleNotOne(in, out);
        double x1 = getPositiveDoubleNotOne(in, out);
        double y1 = getPositiveDoubleNotOne(in, out);
        double z1 = getPositiveDoubleNotOne(in, out);
        /*
         * Call the third method to calculate according to the de Jager formula
         * and output a,b,c,d in the formula, the approximated constant, and the
         * smallest relative error
         */
        deJagerFormulaCal(num1, w1, x1, y1, z1, out);
        /*
